...
def parse_data(text):
    ...
    #print(df)
    # 取0~4 欄位 序號,券商,價格,買進股數,賣出股數
    one_df = df[df.columns[:5]] # 取0~4
    #print(one_df)
    # 取6~10欄位 序號,券商,價格,買進股數,賣出股數
    two_df = df[df.columns[6:]]  # 取6~10
    # 去除重複欄位名稱的.1
...
if __name__ == '__main__':
    ...
    res.encoding = 'big5'
    open('test.text', 'w', encoding='utf-8').write(res.text)
